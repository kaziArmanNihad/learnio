  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-white via-gray-50/30 to-blue-50/20 p-4">
      <div className="hover:shadow-3xl w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white shadow-2xl transition-all duration-300">
        ...
        <div className="relative h-32 overflow-hidden bg-gradient-to-r from-orange-500 to-purple-500">
        ...
        <div className="relative -mt-16 mb-6 flex justify-center">
          <div className="group relative">
            {imageError || !userPhoto ? (
              // Fallback Avatar
              <div className="flex h-32 w-32 items-center justify-center rounded-full border-4 border-white bg-gradient-to-br from-gray-600 to-gray-800 shadow-lg">
        ...
        <div className="space-y-6 px-8 pb-8">
          ...
          <div className="space-y-4 rounded-xl bg-gray-200 p-6">
            <div className="group flex items-center space-x-3">
              <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-orange-100 transition-colors duration-200 group-hover:bg-orange-200">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            >
              <button className="group flex w-full transform items-center justify-center space-x-2 rounded-xl bg-gradient-to-r from-orange-500 to-purple-500 px-6 py-3 font-semibold text-white transition-all duration-300 hover:scale-105 hover:from-orange-600 hover:to-purple-700 hover:shadow-lg">
